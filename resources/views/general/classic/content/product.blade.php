...
@section('meta_tag')
    ...
    <meta property="og:image" content="{{(!empty($post) && !empty($post->postMeta->where('meta_key', 'fb_share_image')->first()) && $post->postMeta->where('meta_key', 'fb_share_image')->first()->meta_value != null) ? asset($post->postMeta->where('meta_key', 'fb_share_image')->first()->meta_value) : (!empty($post) && !empty($post->postMeta->where('meta_key', 'feature_image')->first()) && $post->postMeta->where('meta_key', 'feature_image')->first()->meta_value != null ? generate_storage_url($post->postMeta->where('meta_key', 'feature_image')->first()->meta_value) : '')}}"/>
                    ...
                    <div class="w-100" itemscope itemtype="http://schema.org/Product">
                        ...
                        <div class="w-100 d-flex justify-content-center">
                            @if(!empty($post) && !empty($post->postMeta->where('meta_key', 'feature_image')->first()) && $post->postMeta->where('meta_key', 'feature_image')->first()->meta_value != null)
                                <img class="img-header d-none d-lg-block" id="magnificier" src="{{generate_storage_url($post->postMeta->where('meta_key', 'feature_image')->first()->meta_value)}}" alt="" itemprop="image"> 
                                <img class="img-header d-lg-none" id="magnificier" src="{{generate_storage_url($post->postMeta->where('meta_key', 'feature_image')->first()->meta_value)}}" alt="" itemprop="image"> 
                            @endif
                        </div>
                        <hr>
                            <div class="col-12">
